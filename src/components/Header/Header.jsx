...
<div class="dashboard-header">
    <nav class="navbar navbar-expand-lg bg-white fixed-top collapse navbar-collapse" > <Link class="navbar-brand" to="/">Smart Home.lk</Link> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
